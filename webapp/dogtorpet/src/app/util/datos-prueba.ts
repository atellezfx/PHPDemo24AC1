...
export let mascotasPrueba: Mascota[] = [
  ...
  { id:9, nombre:'Chicharito', propietario:4, fechaNac:new Date('2018-12-19'), raza:'Mestizo', color:'Negro/Blanco', genero:'macho', tipo:1, fotoUrl:'https://png.pngtree.com/png-vector/20190820/ourmid/pngtree-no-image-vector-illustration-isolated-png-image_1694547.jpg' },
